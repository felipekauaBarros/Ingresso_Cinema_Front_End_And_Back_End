...
export class CompraIngressoControllerService extends BaseService {
   ...
   */
  static readonly ObterPorId1Path = '/api/v1/comprar/{id}';
  ...
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, CompraIngressoControllerService.ObterPorId1Path, 'get');
    if (params) {
   ...
   */
  static readonly Alterar1Path = '/api/v1/comprar/{id}';
  ...
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, CompraIngressoControllerService.Alterar1Path, 'put');
    if (params) {
      rb.path('id', params.id, {});
   ...
   */
  static readonly Remover1Path = '/api/v1/comprar/{id}';
  ...
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, CompraIngressoControllerService.Remover1Path, 'delete');
    if (params) {
      rb.path('id', params.id, {});
    }
   ...
   */
  static readonly ListAll1Path = '/api/v1/comprar';
  ...
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, CompraIngressoControllerService.ListAll1Path, 'get');
    if (params) {
    }
   ...
   */
  static readonly Incluir1Path = '/api/v1/comprar';
  ...
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, CompraIngressoControllerService.Incluir1Path, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
